  ...
  app.get("/auth/public-config", async () => {
    ...
    return {
      ...
      features: {
        ...
        music: (appSettings?.musicGenEnabled ?? false) && !(appSettings?.musicNavHidden ?? false),
        ...
        toolsMenu: appSettings?.toolsMenuEnabled ?? true,
        notifyBanner: appSettings?.notifyBannerEnabled ?? true,
      },
